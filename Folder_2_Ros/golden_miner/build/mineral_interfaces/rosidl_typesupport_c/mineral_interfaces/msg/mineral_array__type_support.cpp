...
static const _MineralArray_type_support_symbol_names_t _MineralArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mineral_interfaces, msg, MineralArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mineral_interfaces, msg, MineralArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mineral_interfaces, msg, MineralArray)() {
  return &::mineral_interfaces::msg::rosidl_typesupport_c::MineralArray_message_type_support_handle;
}
