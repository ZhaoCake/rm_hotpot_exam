...
static const _MineralArray_type_support_symbol_names_t _MineralArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mineral_interfaces, msg, MineralArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mineral_interfaces, msg, MineralArray)),
  }
};
...
{
  return &::mineral_interfaces::msg::rosidl_typesupport_cpp::MineralArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mineral_interfaces, msg, MineralArray)() {
  return get_message_type_support_handle<mineral_interfaces::msg::MineralArray>();
}
