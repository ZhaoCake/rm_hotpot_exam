...
bool mineral_interfaces__msg__mineral__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mineral_interfaces.msg._mineral.Mineral", full_classname_dest, 39) == 0);
  }
  mineral_interfaces__msg__Mineral * ros_message = _ros_message;
  {  // index
...
PyObject * mineral_interfaces__msg__mineral__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mineral_interfaces.msg._mineral");
