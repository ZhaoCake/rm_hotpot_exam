...
#include "mineral_interfaces/msg/detail/mineral__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mineral_interfaces::msg::Mineral & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mineral_interfaces::msg::Mineral & ros_message)
{
  // Member: index
  cdr >> ros_message.index;
...
{
  auto typed_message =
    static_cast<const mineral_interfaces::msg::Mineral *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mineral_interfaces::msg::Mineral *>(
    untyped_ros_message);
...
{
  return &mineral_interfaces::msg::typesupport_fastrtps_cpp::_Mineral__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mineral_interfaces, msg, Mineral)() {
  return &mineral_interfaces::msg::typesupport_fastrtps_cpp::_Mineral__handle;
}
