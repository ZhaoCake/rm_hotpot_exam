...
bool au_interfaces__msg__mineralsingle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("au_interfaces.msg._mineralsingle.Mineralsingle", full_classname_dest, 46) == 0);
  }
  au_interfaces__msg__Mineralsingle * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of Mineralsingle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("au_interfaces.msg._mineralsingle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Mineralsingle");
